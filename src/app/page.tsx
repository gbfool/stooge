    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Stooge allows you to have conversations with any PDF document. Simply
          upload your file and start asking questions right away.
        </p>
        <Link
          className={buttonVariants({ size: "lg", class: "mt-5" })}
          href="/dashboard"
          target="_blank"
        >
      ...
      {/* feature section */}
      <div className="mx-auto mb-32 mt-32 md:max-w-2xl lg:max-w-5xl sm:mt-56">
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto sm:text-center max-w-2xl">
            ...
            <p className="mt-4 text:lg text-gray-600">
              Chatting with your PDF has never been easier with Stooge
            </p>
          </div>
        </div>
        {/* steps */}
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="text-zinc-700">
                It&apos;s that simple. Try out Stooge today - it really takes
                than a minute
              </span>
            </div>
          </li>
